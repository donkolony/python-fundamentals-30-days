...
def most_spoken_languages(file_path, top_n=10):
    with open(file_path, encoding="utf-8") as f:
        ...
        sorted_languages = sorted(
            [(count, language) for language, count in language_count.items()],
            reverse=True,
        )
...
pprint.pprint(find_most_common_words(ten_most_frequent_words_michelle_speech, 10))
...
pprint.pprint(find_most_common_words(ten_most_frequent_words_melina_speech, 10))
...
most_repeated_words_romeo_and_juliet = find_most_common_words(romeo_and_juliet, 10)
...
print("Java (not JavaScript):", count_matching_lines(csv_path, java_not_js_pattern))
